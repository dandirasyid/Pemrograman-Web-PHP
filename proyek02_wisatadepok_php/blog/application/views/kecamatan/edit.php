...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <h3 class="text-center">Form Edit Kecamatan</h3>
                ...
                <?php echo form_open('kecamatan/save') ?> 
                    <div class="form-group row">  
                        ...
                        <div class="input-group">
                            ...
                            <input id="nama" name="nama" placeholder="Masukkan Kecamatan" type="text" value="<?php echo $obj_kecamatan->nama ?>" class="form-control" >
                        </div>
                        </div>
                    </div> 
                    <div class="form-group row">

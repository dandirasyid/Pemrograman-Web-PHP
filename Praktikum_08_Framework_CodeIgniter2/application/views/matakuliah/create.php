    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Form Kelola Matakuliah</h3>
            ...
            <?php echo form_open('matakuliah/save')?>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="kode" name="kode" placeholder="Masukkkan Kode Anda" type="text" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nama" name="nama" placeholder="Masukkan Nama Matakuliah Anda" type="text" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
